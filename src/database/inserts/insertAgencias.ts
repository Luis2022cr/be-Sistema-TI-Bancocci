...
export const insertAgencias = async (connection: Connection) => {
  ...
  const agencias = [
    ...
    { nombre: 'Ag. El Junco', codigo: '218', ubicacion: 'Santa Bárbara', estado_agencias_id: 1 },
    { nombre: 'Ag. Santa Bárbara', codigo: '208', ubicacion: 'Santa Bárbara', estado_agencias_id: 1 },
    { nombre: 'Ag. San Luis', codigo: '203', ubicacion: 'Santa Bárbara', estado_agencias_id: 1 },
